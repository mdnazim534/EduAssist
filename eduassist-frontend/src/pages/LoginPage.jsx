  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-surface">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-brand-500/8 blur-[100px]" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 rounded-full bg-ocean-400/6 blur-[100px]" />
      </div>
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/40">Sign in to continue studying smarter</p>
        </div>
        ...
        <div className="glass rounded-2xl p-7 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button onClick={() => handleOAuth('google')} disabled={!!oauthLoading} className="btn-secondary justify-center py-2.5 text-sm">
              {oauthLoading === 'google' ? <Spinner size="sm" /> : <GoogleIcon />}
              Google
            </button>
            <button onClick={() => handleOAuth('github')} disabled={!!oauthLoading} className="btn-secondary justify-center py-2.5 text-sm">
